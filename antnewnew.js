...
class ant{
    ...
    iteration()
    {
        ...
        if (this.IsThereFood)
        {
            if (Cells[this.x][this.y].foodPheromone < 10)
                Cells[this.x][this.y].foodPheromone += 1;
            Cells[this.x][this.y].foodPheromoneDistance = this.Distance;
        }
        else
        {
            if(Cells[this.x][this.y].foodPheromone < 10)
                Cells[this.x][this.y].homePheromone += 1;
    ...
    for (let i = 0; i < NeighbourCells.length; ++i)
    {
        if (goingHome)
        {
            if (Cells[NeighbourCells[i].x][NeighbourCells[i].y].homePheromoneDistance != 0)
                ChancesSum += 1/(Cells[NeighbourCells[i].x][NeighbourCells[i].y].homePheromoneDistance);
        }
        else
        {
            if (Cells[NeighbourCells[i].x][NeighbourCells[i].y].foodPheromoneDistance != 0)
                ChancesSum += 1/(Cells[NeighbourCells[i].x][NeighbourCells[i].y].foodPheromoneDistance);
        }
    }
    if (ChancesSum == 0)
    {
        ...
        for (let i = 0; i < NeighbourCells.length; ++i)
        {
            ...
            else if(Cells[NeighbourCells[i].x][NeighbourCells[i].y].colony == 1)
            {
                ...
                else
                {
                    if (goingHome){
                        if (Cells[NeighbourCells[i].x][NeighbourCells[i].y].homePheromoneDistance!= 0)
                        {
                            CellsChances.push((1/Cells[NeighbourCells[i].x][NeighbourCells[i].y].homePheromoneDistance)/(ChancesSum));
                        }
                        else{
                            CellsChances.push(0);
                        }
                        ...
                        if (Cells[NeighbourCells[i].x][NeighbourCells[i].y].foodPheromoneDistance!= 0)
                        {
                            CellsChances.push((1/Cells[NeighbourCells[i].x][NeighbourCells[i].y].foodPheromoneDistance)/(ChancesSum));
                        }
                        else{
                            CellsChances.push(0);
                        }
            ...
            else
            {
                if (goingHome){
                    ...
                    {
                        CellsChances.push((1/Cells[NeighbourCells[i].x][NeighbourCells[i].y].homePheromoneDistance)/(ChancesSum));
                        //console.log((1/Cells[NeighbourCells[i].x][NeighbourCells[i].y].homePheromoneDistance), ChancesSum, (1/Cells[NeighbourCells[i].x][NeighbourCells[i].y].homePheromoneDistance)/(ChancesSum))
                    }
                    else{
                        CellsChances.push(0);
                    }
